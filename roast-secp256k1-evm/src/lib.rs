...
pub mod dkg {
    ...
    pub type Dealer = roast_core::dkg::Dealer<frost_secp256k1_evm::Secp256K1Keccak256>;

    /// Represents participant of Distributed Key Generation.
    pub type Participant = roast_core::dkg::Participant<frost_secp256k1_evm::Secp256K1Keccak256>;
}
